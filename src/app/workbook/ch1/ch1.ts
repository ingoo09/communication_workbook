...
통신 시스템에서 송신기와 수신기의 역할을 각각 간단히 설명하시오.
...
※ 이 문항은 온라인 교재의 저장, 채점, 피드백, 정답 확인 과정을 익히기 위한 연습 문제이다.`,
...
아래 문제의 답을 위 방법 중 하나를 이용하여 작성하시오.
...
※ 이 문항은 그래프형 문제의 입력, 저장 및 채점 방법을 익히기 위한 연습 문제이다.`,
